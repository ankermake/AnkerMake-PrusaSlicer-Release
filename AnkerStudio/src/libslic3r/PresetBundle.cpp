...
// add  @2023-04-24 by ChunLian
const char *PresetBundle::ANKER_BUNDLE = "Anker"; 
const char *PresetBundle::PreferredVendorBundle = PresetBundle::ANKER_BUNDLE;
const char *PresetBundle::PreferredVendorName   = "AnkerMake"; // "Prusa" -> "AnkerMake"
const bool  PresetBundle::BoolShowOtherVendors  = false;
const bool  PresetBundle::BoolHasSLA            = false;
const bool  PresetBundle::BoolAnkerMain         = true ;
...
// Import newer configuration from alternate AnkerStudio configuration directory.
