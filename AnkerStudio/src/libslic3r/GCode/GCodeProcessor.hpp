...
>>>>>>> 84b4984 (feat: 1.5.21 open source)
  ...
  private:
    ...
    public:
        ...
        // Streaming interface, for processing G-codes just generated by AnkerStudio in a pipelined fashion.
    ...
    private:
        ...
        bool process_ankerstudio_tags(const std::string_view comment);
