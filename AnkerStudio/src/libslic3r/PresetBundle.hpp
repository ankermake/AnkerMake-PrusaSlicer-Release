...
public:
    ...
    static const char *ANKER_BUNDLE;
    static const char *PreferredVendorBundle;
    static const char *PreferredVendorName;
    static const bool  BoolShowOtherVendors;
    static const bool  BoolHasSLA;
    static const bool  BoolAnkerMain;
