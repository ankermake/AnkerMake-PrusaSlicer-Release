...
public:
	...
	virtual bool getMqttState();
	virtual bool disConnectMqtt();
	virtual int startConnectMqtt();
	virtual int sendMsgToMqtt(const std::string& topic, const std::string& msg);
	...
	virtual bool closeVideoStream(int reason = 0);
	virtual void setCameraLightState(bool onOff);
	virtual void setVideoMode(int mode);
	virtual std::string getVideoCtrlSn();
	virtual int getVideoCtrlState();
