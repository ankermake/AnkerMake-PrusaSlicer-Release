...
class AnkerSavePresetDialog : public AnkerDPIDialog
{
    enum ActionType
    {
        ChangePreset,
...
public:
    struct Item
    {
        ...
        Item(Preset::Type type, const std::string& suffix, wxBoxSizer* sizer, AnkerSavePresetDialog* parent, bool is_for_multiple_save);
        Item(wxWindow* parent, wxBoxSizer* sizer, const std::string& def_name, PrinterTechnology pt = ptFFF);
    ...
    private:
        ...
        wxStaticBitmap* m_valid_bmp{ nullptr };
        // add by allen for ankerCfgDlg AnkerSavePresetDialog
        AnkerSimpleCombox* m_combo{ nullptr };
        //wxComboBox* m_combo{ nullptr };
        wxTextCtrl* m_text_ctrl{ nullptr };
        wxStaticText* m_valid_label{ nullptr };
...
private:
    ...
    wxButton* m_pOKBtn{ nullptr };

public:

    const wxString& get_info_line_extention() { return m_info_line_extention; }

    AnkerSavePresetDialog(wxWindow* parent, std::vector<Preset::Type> types, std::string suffix = "", bool template_filament = false, PresetBundle* preset_bundle = nullptr);
    AnkerSavePresetDialog(wxWindow* parent, Preset::Type type, const wxString& info_line_extention);
    ~AnkerSavePresetDialog() override;
