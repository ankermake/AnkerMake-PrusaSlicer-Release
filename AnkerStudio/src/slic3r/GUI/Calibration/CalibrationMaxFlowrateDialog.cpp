...
namespace Slic3r {
namespace GUI {
    CalibrationMaxFlowrateDialog::CalibrationMaxFlowrateDialog(wxWindow* parent, wxWindowID id, Plater* plater)
        : wxDialog(parent, id, _L("common_calib_max_volumetric_speed_test"), wxDefaultPosition, parent->FromDIP(wxSize(-1, 280)), wxDEFAULT_DIALOG_STYLE/* | wxRESIZE_BORDER*/), m_plater(plater)
    {
        CenterOnParent();
        ...
        // Settings
        //
        wxString start_vol_str = _L("common_calib_start_volumetric_speed");
        wxString end_vol_str = _L("common_calib_end_volumetric_speed");
        ...
        m_btnStart->Bind(wxEVT_BUTTON, &CalibrationMaxFlowrateDialog::on_start, this);
        v_sizer->Add(m_btnStart, 0, wxALL | wxALIGN_RIGHT, FromDIP(5));

        m_btnStart->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CalibrationMaxFlowrateDialog::on_start), NULL, this);
    ...
    CalibrationMaxFlowrateDialog::~CalibrationMaxFlowrateDialog() {
        // Disconnect Events
        m_btnStart->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CalibrationMaxFlowrateDialog::on_start), NULL, this);
    }

    void CalibrationMaxFlowrateDialog::on_start(wxCommandEvent& event) {
    ...
    //void CalibrationMaxFlowrateDialog::on_dpi_changed(const wxRect& suggested_rect) {
    //    this->Refresh();
    //    Fit();
