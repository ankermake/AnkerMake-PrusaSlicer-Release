...
#define SCROLL_D_MOTION 4
		...
		class AnkerScrolledWindow;

		class AnkerScrollbar : public wxPanel
		{
		public:
			AnkerScrollbar(wxWindow* parent, wxWindowID id, wxPoint position, wxSize size, AnkerScrolledWindow* scrolledWindow, long direction, int scrollbarWidth, int tipLength = 0);
		...
		private:
			...
			AnkerScrolledWindow* m_scrolledWindow;	// the scrolledWindow whose the scrollbar is controlling
