...
protected:
    ...
    bool on_is_activable() const override { return true; } // Anker: unavalible
...
private:
    ...
    void initGUI();
    static void checkFontStyleAvailability(Emboss::StyleManager& styleManger);
    ...
    wxPanel* m_embossPanel{ nullptr };
    bool m_panelVisibleFlag = false;

    // Embossed Text
    AnkerLineEditUnit* m_embossedTextEdit{ nullptr };


    // Style
    AnkerSimpleCombox* m_styleNormalComboBox{ nullptr };
    ScalableButton* m_renameStyleBtn{ nullptr };
    ScalableButton* m_saveStyleBtn{ nullptr };
    ScalableButton* m_saveAsStyleBtn{ nullptr };
    ScalableButton* m_deleteStyleBtn{ nullptr };


    // Font
    wxStaticText* m_fontText{ nullptr };
    AnkerSimpleCombox* m_fontComboBox{ nullptr };
    ScalableButton* m_fontSetItalicBtn{ nullptr };
    ScalableButton* m_fontSetBoldBtn{ nullptr };


    // Height
    wxStaticText* m_heightText{ nullptr };
    ScalableButton* m_heightResetBtn{ nullptr };
    AnkerLineEditUnit* m_heightEdit{ nullptr };
    ScalableButton* m_heightPlusBtn{ nullptr };
    ScalableButton* m_heightSubtractionBtn{ nullptr };


    // Depth
    wxStaticText* m_depthText{ nullptr };
    AnkerLineEditUnit* m_depthEdit{ nullptr };
    ScalableButton* m_depthPlusBtn{ nullptr };
    ScalableButton* m_depthSubtractionBtn{ nullptr };


    // Advanced
    wxStaticText* m_advancedText{ nullptr };
    ScalableButton* m_advancedBtn{ nullptr };

    wxPanel* m_advancedPanel{ nullptr };

    AnkerCheckBox* m_useSurfaceCheckBox{ nullptr };

    AnkerCheckBox* m_perGlyph{ nullptr };

    wxStaticText* m_alignmentText{ nullptr };
    ScalableButton* m_alignmentLeftBtn{ nullptr };
    ScalableButton* m_alignmentLRCenterBtn{ nullptr };
    ScalableButton* m_alignmentRightBtn{ nullptr };
    ScalableButton* m_alignmentUpBtn{ nullptr };
    ScalableButton* m_alignmentUDCenterBtn{ nullptr };
    ScalableButton* m_alignmentDownBtn{ nullptr };

    wxStaticText* m_charGapText{ nullptr };

    wxStaticText* m_lineGapText{ nullptr };

    wxStaticText* m_boldnessText{ nullptr };

    wxStaticText* m_skewRatioText{ nullptr };

    wxStaticText* m_fromSurfaceText{ nullptr };

    wxStaticText* m_rotationText{ nullptr };

    wxStaticText* m_collectionText{ nullptr };
    AnkerSimpleCombox* m_collectionComboBox{ nullptr };

    AnkerBtn* m_setTextToFaceComeraBtn{ nullptr };
};
