...
public:
	...
	//finds paths to models in message(= command line arguments, first should be ankerStudio executable)
	...
	//						mac - anybody who posts notification with name:@"OtherAnkerStudioTerminating"
